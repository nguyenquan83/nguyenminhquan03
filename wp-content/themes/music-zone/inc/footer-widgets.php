...
class Music_Zone_Footer_Widgets{
	 ...
	 * @var int
	 */
	protected $theme_prefix = 'music_zone';
	...
	function footer_widgets_init() {
		...
		for ( $i = 1; $i <= $this->max_widgets; $i++ ) {
			register_sidebar( array(
				'name'          => sprintf( __( 'Footer Widget %d', 'music-zone' ), $i ),
...
// Initialize.
$music_zone_footer_widgets = new  music_zone_Footer_Widgets();
